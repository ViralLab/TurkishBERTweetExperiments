"""
Dataset already contains prompts!
"""
...
def make_inference(example):
    messages = [
        {
            "role": "user",
            "content": f"""VRL-Detector, verilen Türkçe metnin Nefret Söylemi içerip içermediğini tespit edebilen bir chatbot'tur. "{example['text']}""",
        },
    ]
...
output_path = f"Trendyol_output/{ds_name}"
# save the output
